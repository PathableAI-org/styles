...
export const AccentWarm = {
  render: () => '<button class="pathable-button pathable-button--accent-warm">Accent Warm</button>',
};
...
export const Inverse = {
  render: () => '<button class="pathable-button pathable-button--inverse">Inverse</button>',
};

export const Base = {
  render: () => '<button class="pathable-button pathable-button--base">Base</button>',
};

export const Secondary = {
  render: () => '<button class="pathable-button pathable-button--secondary">Secondary</button>',
};
