export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          '**Note:** This component requires USWDS JavaScript for full interactivity (modal open/close toggle, etc.). Only static CSS documentation is provided here. See the USWDS documentation for JS setup.',
      },
    },
  },
}
