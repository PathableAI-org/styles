...
<div class="pathable-date-range-picker">
  <div class="pathable-date-picker usa-date-picker pathable-date-range-picker__range-start usa-date-range-picker__range-start">
      ...
      <div class="pathable-date-picker__wrapper usa-date-picker__wrapper">
        <input id="drp-start" class="pathable-date-picker__external-input usa-date-picker__external-input pathable-input pathable-input--date" type="text" name="startDate" pattern="\\d{2}\\/\\d{2}\\/\\d{4}" placeholder="MM/DD/YYYY" />
      </div>
  </div>
  <div class="pathable-date-picker usa-date-picker pathable-date-range-picker__range-end usa-date-range-picker__range-end">
      ...
      <div class="pathable-date-picker__wrapper usa-date-picker__wrapper">
        <input id="drp-end" class="pathable-date-picker__external-input usa-date-picker__external-input pathable-input pathable-input--date" type="text" name="endDate" pattern="\\d{2}\\/\\d{2}\\/\\d{4}" placeholder="MM/DD/YYYY" />
      </div>
  </div>
</div>
  `,
