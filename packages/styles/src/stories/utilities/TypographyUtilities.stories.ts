    ...
    <div style="padding: 1rem;">
      ...
      <div style="display: flex; flex-direction: column; gap: 1rem;">
        <div style="display: flex; align-items: center; gap: 1rem; padding: 0.75rem; background: #f9f9f9; border-radius: 4px;">
          ...
          <span style="font-family: monospace; font-size: 0.7rem; color: #555; margin-left: auto;">.pathable-font-family-ui</span>
        </div>
        <div style="display: flex; align-items: center; gap: 1rem; padding: 0.75rem; background: #f9f9f9; border-radius: 4px;">
          ...
          <span style="font-family: monospace; font-size: 0.7rem; color: #555; margin-left: auto;">.pathable-font-family-heading</span>
        </div>
        <div style="display: flex; align-items: center; gap: 1rem; padding: 0.75rem; background: #f9f9f9; border-radius: 4px;">
          ...
          <span style="font-family: monospace; font-size: 0.7rem; color: #555; margin-left: auto;">.pathable-font-family-body</span>
        </div>
        <div style="display: flex; align-items: center; gap: 1rem; padding: 0.75rem; background: #f9f9f9; border-radius: 4px;">
          ...
          <span style="font-family: monospace; font-size: 0.7rem; color: #555; margin-left: auto;">.pathable-font-family-code</span>
        </div>
        <div style="display: flex; align-items: center; gap: 1rem; padding: 0.75rem; background: #f9f9f9; border-radius: 4px;">
          ...
          <span style="font-family: monospace; font-size: 0.7rem; color: #555; margin-left: auto;">.pathable-font-family-serif</span>
        </div>
      </div>
    </div>
  `,
    ...
    <div style="padding: 1rem;">
      ...
      <div style="display: flex; flex-direction: column; gap: 1rem;">
        <div style="display: flex; align-items: center; gap: 1rem; padding: 0.75rem; background: #f9f9f9; border-radius: 4px;">
          ...
          <span style="font-family: monospace; font-size: 0.7rem; color: #555; margin-left: auto;">.pathable-text-normal</span>
        </div>
        <div style="display: flex; align-items: center; gap: 1rem; padding: 0.75rem; background: #f9f9f9; border-radius: 4px;">
          ...
          <span style="font-family: monospace; font-size: 0.7rem; color: #555; margin-left: auto;">.pathable-text-bold</span>
        </div>
        <div style="display: flex; align-items: center; gap: 1rem; padding: 0.75rem; background: #f9f9f9; border-radius: 4px;">
          ...
          <span style="font-family: monospace; font-size: 0.7rem; color: #555; margin-left: auto;">.pathable-text-heavy</span>
        </div>
      </div>
    </div>
  `,
