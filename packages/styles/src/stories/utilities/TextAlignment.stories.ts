    ...
    <div style="padding: 1rem;">
      ...
      <div style="display: flex; flex-direction: column; gap: 1rem;">
        <div style="background: #f9f9f9; padding: 1rem; border-radius: 4px;">
          ...
          <span style="font-family: monospace; font-size: 0.7rem; color: #555;">.pathable-text-left</span>
        </div>
        <div style="background: #f9f9f9; padding: 1rem; border-radius: 4px;">
          ...
          <span style="font-family: monospace; font-size: 0.7rem; color: #555;">.pathable-text-center</span>
        </div>
        <div style="background: #f9f9f9; padding: 1rem; border-radius: 4px;">
          ...
          <span style="font-family: monospace; font-size: 0.7rem; color: #555;">.pathable-text-right</span>
        </div>
      </div>
    </div>
  `,
    ...
    <div style="padding: 1rem;">
      ...
      <div style="display: flex; flex-direction: column; gap: 0.75rem;">
        <div style="padding: 0.75rem; background: #f9f9f9; border-radius: 4px;">
          ...
          <span style="color: #444; font-size: 0.8rem; margin-left: 0.5rem;">&mdash; center at 480px+</span>
        </div>
        <div style="padding: 0.75rem; background: #f9f9f9; border-radius: 4px;">
          <code style="font-size: 0.875rem;">.tablet\\:pathable-text-left</code>
          <span style="color: #444; font-size: 0.8rem; margin-left: 0.5rem;">&mdash; left at 640px+</span>
        </div>
        <div style="padding: 0.75rem; background: #f9f9f9; border-radius: 4px;">
          <code style="font-size: 0.875rem;">.desktop\\:pathable-text-right</code>
          <span style="color: #444; font-size: 0.8rem; margin-left: 0.5rem;">&mdash; right at 1024px+</span>
        </div>
      </div>
