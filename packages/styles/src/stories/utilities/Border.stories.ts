      ...
      <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
        ${[0, 1, 2, 3, 4, 5]
          ...
          <div style="text-align: center;">
            ...
            <div style="margin-top: 0.5rem; font-family: monospace; font-size: 0.7rem; color: #444;">border-${n}</div>
          </div>
        `,
          )
          .join('')}
    ...
    <div style="padding: 1rem;">
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 2rem;">
        <div style="text-align: center;">
          ...
          <div style="margin-top: 0.5rem; font-family: monospace; font-size: 0.7rem; color: #444;">border-radius-sm</div>
        </div>
        <div style="text-align: center;">
          ...
          <div style="margin-top: 0.5rem; font-family: monospace; font-size: 0.7rem; color: #444;">border-radius-md</div>
        </div>
        <div style="text-align: center;">
          ...
          <div style="margin-top: 0.5rem; font-family: monospace; font-size: 0.7rem; color: #444;">border-radius-lg</div>
        </div>
      </div>
    </div>
  `,
