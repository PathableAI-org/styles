    ...
    <div style="padding: 1rem;">
      ...
      <div style="display: flex; flex-direction: column; gap: 1rem;">
        ${[
          ...
          { label: 'Mobile LG', class: 'pathable-maxw-mobile-lg', width: 'mobile-lg (480px)' },
          { label: 'Tablet', class: 'pathable-maxw-tablet', width: 'tablet (640px)' },
          { label: 'Desktop', class: 'pathable-maxw-desktop', width: 'desktop (1024px)' },
        ].map(({ label, class: cls, width }) => `
          <div style="background: #f9f9f9; padding: 0.75rem; border-radius: 4px;">
