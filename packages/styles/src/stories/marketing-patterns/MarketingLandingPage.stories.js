...
const audienceHtml = `
<section style="padding: 4rem 1rem; background: var(--pathable-color-surface, #f8f9fa);">
  <div class="pathable-container pathable-container--standard">
    <div class="pathable-cluster pathable-cluster--gap-lg" style="justify-content: center; text-align: center;">
      <div class="pathable-surface pathable-surface--raised" style="padding: 2rem; flex: 1; min-width: 200px; max-width: 300px;">
        ...
        <p style="margin: 0; font-size: 0.875rem; line-height: 1.5; color: #555;">Simplify documentation and focus on what matters — your participants.</p>
      </div>
      <div class="pathable-surface pathable-surface--raised" style="padding: 2rem; flex: 1; min-width: 200px; max-width: 300px;">
        <h3 style="margin: 0 0 0.5rem; font-size: 1.125rem; font-weight: 600;">Program Managers</h3>
        <p style="margin: 0; font-size: 0.875rem; line-height: 1.5; color: #555;">Get real-time visibility into outcomes, compliance, and team performance.</p>
      </div>
      <div class="pathable-surface pathable-surface--raised" style="padding: 2rem; flex: 1; min-width: 200px; max-width: 300px;">
        <h3 style="margin: 0 0 0.5rem; font-size: 1.125rem; font-weight: 600;">Administrators</h3>
        <p style="margin: 0; font-size: 0.875rem; line-height: 1.5; color: #555;">Meet reporting requirements and demonstrate funder impact with confidence.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="pathable-container pathable-container--standard">
    <div class="pathable-split pathable-split--ratio-1-2" style="align-items: center;">
      <div class="pathable-stack pathable-stack--gap-md">
        ...
        <p style="margin: 0; font-size: 1rem; line-height: 1.6; color: #555;">From enrollment to outcome, every step of the participant journey is documented and accessible. Reduce paperwork and spend more time on meaningful interactions.</p>
  ...
  <div class="pathable-container pathable-container--standard">
    <div class="pathable-split pathable-split--ratio-2-1" style="align-items: center;">
      ...
      <div class="pathable-stack pathable-stack--gap-md">
        ...
        <p style="margin: 0; font-size: 1rem; line-height: 1.6; color: #555;">Generate funder-ready reports with a single click. Track outcomes across programs, identify trends, and demonstrate the impact of your work.</p>
...
<section style="padding: 4rem 1rem;">
  <div class="pathable-container pathable-container--standard">
    <div class="pathable-stack pathable-stack--gap-lg" style="align-items: center; text-align: center;">
      ...
      <p style="margin: 0; font-size: 1rem; color: #555; max-width: 480px;">Organizations of all sizes rely on PathAble to deliver better outcomes.</p>
...
<section class="pathable-decorative-bg pathable-decorative-bg--glow" style="padding: 4rem 1rem;">
  <div class="pathable-container pathable-container--standard" style="text-align: center;">
    <div class="pathable-stack pathable-stack--gap-md" style="align-items: center;">
      ...
      <p style="margin: 0; font-size: 1.125rem; color: #555; max-width: 480px;">Join hundreds of organizations already using PathAble to deliver better outcomes.</p>
...
const footerHtml = `
<footer class="pathable-footer" style="padding: 2rem 1rem; border-top: 1px solid var(--pathable-color-border, #ddd);">
  <div class="pathable-container pathable-container--standard">
    <div style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 2rem;">
      <div>
        ...
        <p style="margin: 0; font-size: 0.875rem; color: #666;">Empowering workforce programs.</p>
      </div>
    ...
    <p style="margin: 1rem 0 0; font-size: 0.75rem; color: #999; text-align: center;">&copy; 2026 PathAble. All rights reserved.</p>
  </div>
</footer>
`
    ...
    <div class="pathable-container pathable-container--standard">
      <div class="pathable-stack pathable-stack--gap-lg">
        <div class="pathable-stack pathable-stack--gap-md">
          ...
          <p style="margin: 0; font-size: 1rem; line-height: 1.6; color: #555;">From enrollment to outcome, every step is documented and accessible.</p>
    ...
    <div class="pathable-container pathable-container--standard">
      <div class="pathable-stack pathable-stack--gap-lg">
        ...
        <div class="pathable-stack pathable-stack--gap-md">
          ...
          <p style="margin: 0; font-size: 1rem; line-height: 1.6; color: #555;">Generate funder-ready reports with a single click.</p>
