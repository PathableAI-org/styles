...
const EXPECTED_COVERAGE = {
  ...
  'Form controls': [
    ...
    'components-form-controls-form-stack--default',
    'components-form-controls-form-stack--constrained',
    'components-form-controls-form-stack--explicit-control-constraint',
    'components-form-controls-form-stack--with-form-row',
    'components-form-controls-form-stack--narrow',
    'components-form-controls-form-row--default',
    'components-form-controls-form-row--long-labels-and-hints',
    'components-form-controls-form-row--mixed-control-heights',
    'components-form-controls-form-row--uneven-errors',
    'components-form-controls-form-row--constrained-three-fields',
    'components-form-controls-form-row--in-pathable-form',
    'components-form-controls-form-row--gap-sizes',
    ...
    'components-form-controls-filterable-option-list--default',
    'components-form-controls-filterable-option-list--selected',
    'components-form-controls-filterable-option-list--disabled',
    'components-form-controls-filterable-option-list--empty',
    'components-form-controls-filterable-option-list--no-matches',
    'components-form-controls-filterable-option-list--long-content',
    'components-form-controls-filterable-option-list--many-options',
    'components-form-controls-filterable-option-list--narrow',
    'components-form-controls-filterable-option-list--increased-text',
    'components-form-controls-filterable-option-list--forced-colors',
    'components-form-controls-input--default',
    'components-form-controls-optional-form-section--default',
    'components-form-controls-optional-form-section--expanded',
    'components-form-controls-optional-form-section--nested-form-group',
    ...
    'components-form-controls-optional-form-section--long-content',
    'components-form-controls-optional-form-section--narrow',
    'components-form-controls-optional-form-section--increased-text',
    'components-form-controls-optional-form-section--forced-colors',
