...
**Accessibility**: Compose one Label and any Hint or ErrorMessage children directly with one Input, Select, Textarea, or Range to receive stable IDs and associations automatically. Explicit non-empty IDs and ARIA attributes are preserved. A non-empty \`aria-labelledby\` opts out of automatic Label wiring; an explicit \`aria-describedby\`, including an empty string, opts out of description wiring. Multiple direct controls, including a supported control mixed with a native or PathAble composite control, disable automatic wiring. Use a native \`<fieldset>\` when controls need a shared group name.`,
      },
    },
  },
  argTypes: {
