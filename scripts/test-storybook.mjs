...
export const targets = {
  styles: {
    ...
    fixtures: {
      ...
      'checkbox.default': 'components-form-controls-checkbox--default',
      'checkbox.disabled': 'components-form-controls-checkbox--disabled',
      'checkbox.required': 'components-form-controls-checkbox--required',
