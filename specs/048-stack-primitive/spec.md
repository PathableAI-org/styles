...
- **FR-003**: The `as` prop MUST be polymorphically typed so that TypeScript constrains accepted props to those valid for the selected HTML element and prevents void elements from being selected.
