...
- Wave order is A (stateful keyboard/focus) → B (form controls) → C (navigation,
  ...
  same user-facing promise. The subsequently approved IconTile and Integration
  continuations remain Styles-only, preserve independent focused proofs, and do
  not imply completion of unfinished earlier waves.
